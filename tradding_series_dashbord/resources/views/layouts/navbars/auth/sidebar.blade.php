<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('virtual-reality') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Réalité Virtuelle</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-link mb-0">
                <a href="https://www.creative-tim.com/product/soft-ui-dashboard-pro-laravel"
                    class="btn  btn-md active px-5 text-white" style="background: #0a8897" target="_blank" role="button"
                    aria-pressed="true">
                    Upgrade to PRO</a>
            </li>
        </ul>
    ...
    <div class=" mx-3 ">
        <div class=" d-flex  mt-2 shadow-none" id="sidenavCard" style="height: 100px;">
                <img src="../assets/img/curved-images/logo-ewm-carre.jpg" style="width: 50%; height: 100%;"></img>
            </div>
