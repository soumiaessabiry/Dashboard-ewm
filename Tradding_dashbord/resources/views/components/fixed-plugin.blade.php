    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="{{ (Request::is('rtl') ? 'float-end' : 'float-start') }}">
          <h5 class="mt-3 mb-0">Dashbord options</h5>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="d-flex">
          <button class="btn w-100 px-3 mb-2 active text-white" data-class="bg-transparent" style="background: #0a8897" onclick="sidebarType(this)">Transparent</button>
          <button class="btn bg-white text-black w-100 px-3 mb-2  {{ (Request::is('rtl') ? 'me-2' : 'ms-2') }}" data-class="bg-white" onclick="sidebarType(this)">White</button>
        </div>
        <!-- Navbar Fixed -->
        <div class="mt-3">
